...
//------------------------------------------------------------
/*  [Any, AnyObject, nil, Never]  */
// - Any : 스위프트의 모든 데이터 타입을 사용할 수 있다는 뜻. 변수/상수
// - AnyObject : 클래스의 인스턴스만 할당가능
//------------------------------------------------------------
var someVar: Any = "hello" // String
someVar = 50  // Int
someVar = 100.1 // float, double
//스위프트는 타입에 엄격하기때문에 Any, AnyObject는 될수있다면 사용하지 않는 것이 좋다.
